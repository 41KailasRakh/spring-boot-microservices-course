...
insert into orders (id,order_number,username,
                    ...
                    status,comments) values
                                         (1, 'order-123', 'user', 'Siva', 'kailas@gmail.com', '11111111', '123 Main St', 'Apt 1', 'Dallas', 'TX', '75001', 'USA', 'NEW', null),
                                         (2, 'order-456', 'user', 'rakh', 'rakh@gmail.com', '2222222', '123 Main St', 'Apt 1', 'Hyderabad', 'TS', '500072', 'India', 'NEW', null)
;
